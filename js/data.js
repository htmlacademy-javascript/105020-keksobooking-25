...
const offerLocations = {lat: [35.65000, 35.70000], lng: [139.70000, 139.80000], digits: 5};

const createObjectLocation = () => {
  const location = new Object();
  location.lat = getRandomPositiveFloat(...offerLocations.lat, offerLocations.digits);
  location.lng = getRandomPositiveFloat(...offerLocations.lng, offerLocations.digits);
  return location;
};
